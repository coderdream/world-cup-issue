...
impl OperationLogger {
    ...
    pub fn debug(&self, module: &str, action: &str, message: impl AsRef<str>, detail: impl AsRef<str>) {
        self.log("DEBUG", module, action, message, Some(detail.as_ref()), None);
    }

    pub fn warn(&self, module: &str, action: &str, message: impl AsRef<str>, detail: impl AsRef<str>) {
        self.log("WARN", module, action, message, Some(detail.as_ref()), None);
    }
    ...
    pub fn scan_progress(&self, action: &str, message: impl AsRef<str>, detail: impl AsRef<str>) {
        self.log("INFO", "scan", action, message, Some(detail.as_ref()), None);
    }
