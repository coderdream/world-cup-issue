...
const SEARCH_HISTORY_KEY = "tauri-framework-log-search-history";
    ...
    <div className="page logs-page">
      <Panel className="logs-panel">
        ...
        <div className="log-scope-row">
          <span>当前显示</span>
          <b>全部框架日志</b>
          <code>SQLite operate_log · DEBUG / INFO / WARN / ERROR</code>
        </div>
        ...
        <div className="log-searchbar">
          ...
          <button className={searchOptions.matchCase ? "log-token-btn active" : "log-token-btn"} type="button" title="Match Case Alt+C" onClick={() => toggleSearchOption("matchCase")}>
            Cc
          </button>
          <button className={searchOptions.wholeWord ? "log-token-btn active" : "log-token-btn"} type="button" title="Words Alt+W" onClick={() => toggleSearchOption("wholeWord")}>
            W
          </button>
          <button className={searchOptions.regex ? "log-token-btn active" : "log-token-btn"} type="button" title="Regex Alt+X" onClick={() => toggleSearchOption("regex")}>
            .*
          </button>
