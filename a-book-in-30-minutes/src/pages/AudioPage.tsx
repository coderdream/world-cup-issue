...
const STEP_SPECS: StepSpec[] = [
  ...
  { code: "B-01", name: text("音频：读取旁白"), stage: "audio", threshold: 10, detail: audioTextDetail },
  { code: "B-02", name: text("音频：拆分片段"), stage: "audio", threshold: 35, detail: audioChunkDetail },
  { code: "B-03", name: text("音频：生成语音"), stage: "audio", threshold: 85, detail: audioChunkDetail },
  { code: "B-04", name: text("音频：合成音频"), stage: "audio", threshold: 100, detail: audioFileDetail },
  { code: "C-01", name: text("字幕：生成中文字幕"), stage: "subtitle", threshold: 55, detail: subtitleMaterialDetail },
  { code: "C-02", name: text("字幕：生成双语字幕"), stage: "subtitle", threshold: 65, detail: subtitleDetail },
  { code: "D-01", name: text("图片：生成封面"), stage: "image", threshold: 35, detail: coverDetail },
  { code: "D-02", name: text("图片：生成分镜图"), stage: "image", threshold: 45, detail: imageDetail },
